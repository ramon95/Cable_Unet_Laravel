  ...
  <div class="container-fluid">
    <div class="row">
      <div class="col-md-12">
        <div class="card">
          <div class="header">
            <h4 class="title">Servicio de Canales</h4>
          </div>
          <div class="content">
            <div class="row">
              ...
              <div class="collapse" id="form0">
                ...
                <form method="POST" action="{{route('canalCrear')}}" accept-charset="UTF-8">
                  ...
                  <div class="form-group col-md-6">
                    ...
                    <select class="form-control select2 select2-hidden-accessible" multiple="" style="width: 100%;" tabindex="-1" aria-hidden="true" name="Horas[]" required>
